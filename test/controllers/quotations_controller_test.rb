...
class QuotationsControllerTest < ActionController::TestCase
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post :create, quotation: { chapter_id: @quotation.chapter_id, content: @quotation.content, order: @quotation.order }
    end
  ...
  test "should update quotation" do
    patch :update, id: @quotation, quotation: { chapter_id: @quotation.chapter_id, content: @quotation.content, order: @quotation.order }
    assert_redirected_to quotation_path(assigns(:quotation))
  end
